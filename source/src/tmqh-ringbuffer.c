...
void TmqhRingBufferRegister (void) {
    tmqh_table[TMQH_RINGBUFFER_MRSW].name = "ringbuffer_mrsw";  // 多读单写
    ...
    tmqh_table[TMQH_RINGBUFFER_SRSW].name = "ringbuffer_srsw";  // 单读单写
    ...
    tmqh_table[TMQH_RINGBUFFER_SRMW].name = "ringbuffer_srmw";  // 单读多写
